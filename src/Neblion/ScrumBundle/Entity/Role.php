...
/**
 * Neblion\ScrumBundle\Entity\Role
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Neblion\ScrumBundle\Entity\RoleRepository")
 */
class Role
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="Neblion\ScrumBundle\Entity\Member", mappedBy="role")
     */
    private $members;
